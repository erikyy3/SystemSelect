...
<<<<<<< HEAD
        ...
        txtSenha.setNextFocusableComponent(txtNumCartao);
...
<<<<<<< HEAD
        btnNumCartao.setToolTipText("Alterar ou cadastrar um novo cartão");
        btnNumCartao.setNextFocusableComponent(btnSalvar);
=======
>>>>>>> e9ad854 (Integração do banco de dados)
...
<<<<<<< HEAD
        txtNumCartao.setNextFocusableComponent(btnRemoverCartao);

        btnRemoverCartao.setBackground(new java.awt.Color(204, 0, 51));
        btnRemoverCartao.setText("Remover");
        btnRemoverCartao.setToolTipText("Remover seu cartão atual cadastrado");
        btnRemoverCartao.setNextFocusableComponent(btnNumCartao);
=======
        btnRemoverCartao.setBackground(new java.awt.Color(204, 0, 51));
        btnRemoverCartao.setText("Remover");
>>>>>>> e9ad854 (Integração do banco de dados)
...
<<<<<<< HEAD
            Usuario usuario = new Usuario(txtNome.getText(), txtSenha.getText(), txtEmail.getText(), txtNumCartao.getText(), "Cliente");
            
            Administracao admin = new Administracao();
            admin.atualizarUsuario(usuario, txtNome.getText());
