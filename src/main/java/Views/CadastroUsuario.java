...
public class CadastroUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("System Select - Cadastro de Usuário");

        txtSenha.setToolTipText("Informe a senha que o usuário deseja utilizar");

        jLabel5.setText("Senha:");

        jLabel4.setText("Nome:");

        txtNome.setToolTipText("Informe o nome completo do usuário");
        ...
        txtEmail.setToolTipText("Informe o email que o usuário deseja utilizar");

        jLabel6.setText("Email:");

        jLabel7.setText("N Cartão:");

        txtNumCartao.setToolTipText("Informe o número de cartão que o usuário deseja utilizar");

        jLabel8.setText("Tipo:");

        btnCadastrar.setBackground(new java.awt.Color(0, 102, 204));
        btnCadastrar.setText("Cadastrar");
        btnCadastrar.setToolTipText("Cadastrar os dados informados");
        ...
        jLabel3.setText("os campos com * são obrigatórios");
        ...
        cbxCliente.setToolTipText("O usuário é um Cliente?");
        ...
        cbxAdmin.setText("Administração");
        cbxAdmin.setToolTipText("O usuário é um Administrador?");
...
<<<<<<< HEAD
        ...
        if(!txtNumCartao.getText().isEmpty()){
            numCartao = txtNumCartao.getText();
        }
        
        Usuario novoUsuario = new Usuario(txtNome.getText(), txtSenha.getText(), txtEmail.getText(), numCartao);
...
=======
        ...
        novoUsuario.setNumCartao(txtNumCartao.getText());
>>>>>>> e9ad854 (Integração do banco de dados)
...
<<<<<<< HEAD
        ...
        admin.cadastrarUsuario(novoUsuario);
=======
...
>>>>>>> e9ad854 (Integração do banco de dados)
        ...
        if(validacaoForm == false){
            JOptionPane.showMessageDialog(null, "Todos os campos obrigatórios precisam ser preenchidos");
        }
