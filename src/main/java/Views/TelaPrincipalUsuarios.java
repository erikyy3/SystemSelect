...
<<<<<<< HEAD
        ...
        String senha = JOptionPane.showInputDialog(null, "Informe sua senha para continuar:", "Validação de Senha", JOptionPane.PLAIN_MESSAGE);
        
        boolean verificacaoSenha = admin.validarSenha(senha);
        
        if(verificacaoSenha == true){
            AlteracaoDadosCliente telaAlterarDados = new AlteracaoDadosCliente(SessaoUsuario.getUsuario());
